...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import TurboPFor_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5045cf3f-6bff-515a-9ee9-1318ad640b20"))
platforms = [Pkg.Artifacts.unpack_platform(e, "TurboPFor", artifacts_toml) for e in artifacts["TurboPFor"]]
...
if best_platform === nothing
    @debug("Unable to load TurboPFor; unsupported platform $(triplet(platform_key_abi()))")
else
